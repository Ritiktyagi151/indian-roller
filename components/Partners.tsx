...
// TargetAndTransition ko import kiya gaya hai error fix karne ke liye
import { motion, Variants, TargetAndTransition } from "framer-motion";

export default function Partners() {
  const logos = [
    "/clients-imgs/client1.png", 
  ...
  // Yahan TargetAndTransition type add kiya gaya hai
    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tight text-gray-900 leading-tight">
        ...
        {/* Logos Grid with Enhanced Cards */}
        <motion.div 
          ...
          {logos.map((logo, i) => (
            ...
            >
              ...
              <Image 
                ...
                width={140} 
                height={70} 
                className="object-contain grayscale group-hover:grayscale-0 transition-all duration-500 relative z-10 opacity-70 group-hover:opacity-100" 
              />
            </motion.div>
          ))}
        </motion.div>
